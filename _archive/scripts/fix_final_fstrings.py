...
"""
import logging
# TODO: Fix undefined variables: content, extra_part, f, file_path, fixed_count, fstring_content, level, m, message, original_content, remaining, var_list, var_pattern, variables
...
def fix_fstring_logging(self, file_path):
...
def convert_fstring_with_extra(self, level, fstring_content, extra_part):
...
def convert_simple_fstring(self, level, fstring_content):
