# TODO: Fix undefined variables: additional_files, arg, ast, astor, content, count, e, expected_prints, f, file, file_path, files, files_with_prints, fixed_count, fixer, format_str, fstring_content, has_logger, has_logging_import, i, import_insert_idx, line, lines, logger_attr, m, match, message, new_tree, node, original_content, prints_after, prints_before, remaining_total, root, self, transformer, tree, var_list, var_pattern, variables
#!/usr/bin/env python3
"""
...
import ast
import logging
# TODO: Fix undefined variables: additional_files, arg, content, count, e, expected_prints, f, file, file_path, files, files_with_prints, fixed_count, fixer, format_str, fstring_content, has_logger, has_logging_import, i, import_insert_idx, line, lines, logger_attr, logging, m, match, message, new_tree, node, original_content, os, prints_after, prints_before, re, remaining_total, root, transformer, tree, var_list, var_pattern, variables
...
class PrintStatementFixer:
    ...
    def _apply_regex_fixes(self, content: str) -> str:
        ...
        def fix_fstring_double(self, match):
        ...
        def fix_fstring_single(self, match):
            return self._convert_fstring(match.group(1))
