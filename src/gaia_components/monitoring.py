...
from src.gaia_components.monitoring import jaeger_endpoint
from src.gaia_components.monitoring import jaeger_exporter
from src.gaia_components.monitoring import mem_stats
from src.gaia_components.monitoring import memory_info
from src.gaia_components.monitoring import process
from src.gaia_components.monitoring import rss_values
from src.gaia_components.monitoring import span_processor
from src.gaia_components.monitoring import tracer
...
# TODO: Fix undefined variables: Any, BatchSpanProcessor, Callable, Dict, JaegerExporter, TracerProvider, agent_info, agent_stats, agent_system, args, datetime, duration, e, func, generate_latest, jaeger_endpoint, jaeger_exporter, kwargs, labels, logging, m, mem_stats, memory_info, metric_name, name, os, process, recent, result, rss_values, s, snapshot, span, span_processor, start_time, stats, status, time, tool_name, tool_stats, tool_type, trace, tracer, value, values
...
def monitor_tool_execution(self, tool_name: str, tool_type: str):
